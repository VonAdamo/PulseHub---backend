package com.pulsehub.messageservice.config;
...
public class RabbitMqConfig {
    ...
    TopicExchange messageEventsExchange(
            @Value("${pulsehub.rabbitmq.messages.exchange}") String exchangeName
    ) {
    ...
    Queue messagePublishedQueue(
            @Value("${pulsehub.rabbitmq.messages.queue}") String queueName
    ) {
